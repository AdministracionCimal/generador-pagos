...
- `composicionSaldoProveedor` **no filtra por empresa**: consulta por CUIT y mezcla los documentos de todo el grupo (incluida la empresa de pruebas). Un pago cargado en `Pueba` aparece como crédito en el saldo que ve la app para ese proveedor
